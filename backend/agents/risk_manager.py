...
def get_vote(ticker: str, portfolio: dict = None, peak_value: float = None) -> dict:
    try:
        ...
        if drawdown_pct <= -MAX_DRAWDOWN_PCT:
            return {
                ...
                "reason": (
                    ...
                    "All new BUYs blocked until recovery."
                ),
        ...
        # Approved — cap position size at MAX_SINGLE_POSITION_PCT
